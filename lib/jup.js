        ...
        return {
            ...
            html: function() {
                ...
                var args = Array.prototype.slice.call(arguments),
                        toString = Object.prototype.toString, markup = [],
                        context = {}, replacements = [], converted = "";
                ...
                if (args.length === 2) {
                    ...
                    if (toString.call(args[0]) === "[object Array]") {
                        ...
                        context = args[0].data || {};
                        markup = args[0].structure;
                    }
                }

                if (toString.call(context) == "[object Array]") {
                    for (var i = 0, l = context.length; i < l; i++) {
                        replacements.push(Util.replace(Util.translate(markup), context[i]));
                    }
                    converted = replacements.join("");
                } else if (context) {
                    converted = Util.replace(Util.translate(markup), context);
                }
